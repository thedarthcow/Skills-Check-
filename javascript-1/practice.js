...
colorCopy.push('blue', 'purple', 'orange') // need to understand why it takes in 5 colors instead of 4 to pass?
...
//(this means your counter should decrement), and then add each item to the 'reversed' 
...
// Below is an array, myNumbers. You will be using .map, .filter, .reduce 
//and .forEach to manipulate the array in the following problems.
...
//Then, use forEach to push each item's index from the myNumbers array into the newly 
...
// Using the people array, filter out everyone that isn't a 
//friend into a new array called 'enemies'. Use .filter(). 
const people = [
