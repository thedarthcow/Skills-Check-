...
var me = {
    firstName: "Brad",
    superHeroName: "Coffee Creamer",
    homeTown: "Phoenix",
    superPowers: ["Caffinate", "Foam", "Lava Java"],
...
//The first variable you create should be 'regularName', and it should receive its value from 
//the value of your firstName key on the me object above. The next variable is 'superName' which 
//should have its value assigned as the value of the superHeroName property on the me object. 
...
//////////////////Step 4////////////////////
//Create a function called 'setColor' that takes in one parameter called 'arr' that is an array 
//of colors. Make sure that we only ever have three colors by using splice to trim the array to 
//just 3 colors. 

// Next, create a for loop to loop over the remaining three colors. If any of the colors is 'blue', 
//change it's value to '#4D4DFF' (which is just a more appealing shade of blue). Outside of the 
//for loop but still inside of setColor, invoke the function called 'background' which will take 
//in three arguments. These arguments should be the three items remaining in your colors array. 
